                    ...
                    <div className="container py-4 px-4">
                        ...
                        <div class="columns is-centered py-4">
                            <div class="column is-one-third">
                                <div class="card ">
                                    <div class="card-image">
                                        <StaticImage src="./../img/prabhdev.webp" />
                                    </div>
                            ...
                            <div class="column is-one-third">
                                <div class="card ">
                                    <div class="card-image">
                                        <StaticImage src="./../img/Manjot.avif" />
                                    </div>
                                    <div class="card-content ">
                                        <div class="media has-background-black radius">
                                            <div class="media-content">
                            ...
                            <div class="column is-one-third">
                                <div class="card ">
                                    <div class="card-image">
                                        <StaticImage src="./../img/taranjit.webp" />
                                    </div>
                                    <div class="card-content ">
                                        <div class="media has-background-black radius">
                                            <div class="media-content">
                        ...
                        <div class="columns is-centered py-4">
                            <div class="column is-one-third">
                                <div class="card ">
                                    <div class="card-image">
                                        <StaticImage src="./../img/Balwinder.webp" />
                                    </div>
                                    <div class="card-content ">
                                        <div class="media has-background-black radius">
                                            <div class="media-content">
                                        ...
                                        <div class="media has-background-black radius">
                                            <div class="media-content">
                                                <div className="">
                                                    ...
                                                    <p class="px-4 subtitle py-3 is-6 has-text-light has-text-centered	has-text-weight-bold">
                                                        Aman Singh is a senior software specialist by profession and provides insights into marketing and design as well as implementing technology for the organization. He has been working on Sikh tech projects for over two decades and actively organizes Sikh events as well as doing bi-lingual Kirtan and Katha divaans at Gurdwaras and other Sikhi camps.
